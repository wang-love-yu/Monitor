...
public class ApiErrInterceptor implements Interceptor {
    ...
    public interface Logger {
        ...
        /**
         * A {@link ApiErrInterceptor.Logger} defaults output appropriate for the current platform.
         */
        // ApiErrInterceptor.
    }

    public ApiErrInterceptor() {

    }

    private final ApiErrInterceptor.Logger logger = new ApiErrInterceptor.Logger() {
     ...
     * @return
     */
    public ApiErrInterceptor setLevel(ApiErrInterceptor.Level level) {
        if (level == null) throw new NullPointerException("level == null. Use Level.NONE instead.");
        this.level = level;
        return this;
    }

    public ApiErrInterceptor.Level getLevel() {
        return level;
    }

    @Override
    public Response intercept(Chain chain) throws IOException {
        ApiErrInterceptor.Level level = this.level;
        ...
        boolean logBody = level == ApiErrInterceptor.Level.BODY;
        boolean logHeaders = logBody || level == ApiErrInterceptor.Level.HEADERS;
